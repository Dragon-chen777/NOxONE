<template>
  <div class="kanbanniang">
    <div class="banniang-container" :class="{'small': isShowSmall }" v-show="isLoaded">
      <div class="messageBox" :style="messageStyle" v-show="isShowMessageBox">
        {{ messages.message || '欢迎来到 ' + $site.title + '的小破站~' }}
      </div>
      <div
        v-show="!isShowBtns"
        :style="btnStyle"
...
@require './assets/iconfont/iconfont.css'
  ...
  .banniang-container
    ...
    #banniang
      ...
      pointer-events none
      position fixed
  .banniang-container.small
    .messageBox
      transform: translate(20%, 110%) scale(0.7);
    .operation
      transform: translate(250%, 40%) scale(0.8);
    #banniang
