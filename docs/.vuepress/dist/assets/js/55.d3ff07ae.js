				...
				e = Object(n.a)(
					...
					function () {
						...
						return s('ContentSlotsDistributor', { attrs: { 'slot-key': t.$parent.slotKey } }, [
							s('h2', { attrs: { id: '_1-instanceof-机制' } }, [s('a', { staticClass: 'header-anchor', attrs: { href: '#_1-instanceof-机制' } }, [t._v('#')]), t._v(' 1. instanceof 机制')]),
							t._v(' '),
							s('ol', [
								s('li', [t._v('获取对象的'), s('code', [t._v('__proto__')]), t._v('和判断类型的'), s('code', [t._v('prototype')])]),
								t._v(' '),
								s('li', [t._v('遍历对象上的所有原型直到==判断类型的'), s('code', [t._v('prototype')]), t._v('返回'), s('code', [t._v('true')])]),
								t._v(' '),
								s('li', [t._v('若遍历到尽头也就是 null 了还是没结果返回'), s('code', [t._v('false')])]),
							]),
							t._v(' '),
							s('div', { staticClass: 'language-js extra-class' }, [
								s('pre', { pre: !0, attrs: { class: 'language-js' } }, [
									s('code', [
										...
										s('span', { pre: !0, attrs: { class: 'token parameter' } }, [t._v('left'), s('span', { pre: !0, attrs: { class: 'token punctuation' } }, [t._v(',')]), t._v(' right')]),
										s('span', { pre: !0, attrs: { class: 'token punctuation' } }, [t._v(')')]),
										t._v(' '),
										s('span', { pre: !0, attrs: { class: 'token punctuation' } }, [t._v('{')]),
										t._v('\n  '),
							...
							s('h2', { attrs: { id: '_2-symblol-hasinstance-方法重写' } }, [
								s('a', { staticClass: 'header-anchor', attrs: { href: '#_2-symblol-hasinstance-方法重写' } }, [t._v('#')]),
								t._v(' 2. [Symblol.hasInstance]方法重写'),
							]),
							t._v(' '),
							s('p', [t._v('更精确的来说'), s('code', [t._v('a instanceof B')]), t._v('实际会执行'), s('code', [t._v('B[Symbol.hasInstance](a)')])]),
							t._v(' '),
							s('div', { staticClass: 'language-js extra-class' }, [
								s('pre', { pre: !0, attrs: { class: 'language-js' } }, [
									s('code', [
										s('span', { pre: !0, attrs: { class: 'token comment' } }, [t._v('// instanceof机制')]),
										t._v('\n'),
										...
										t._v('\n\n'),
										s('span', { pre: !0, attrs: { class: 'token comment' } }, [t._v('// 重写')]),
										t._v('\n'),
										s('span', { pre: !0, attrs: { class: 'token keyword' } }, [t._v('class')]),
										t._v(' '),
