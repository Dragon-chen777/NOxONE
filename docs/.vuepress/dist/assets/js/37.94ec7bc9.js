				...
				r = Object(n.a)(
					...
					function () {
						...
						return s('ContentSlotsDistributor', { attrs: { 'slot-key': t.$parent.slotKey } }, [
							s('h2', { attrs: { id: '_1-数组迭代' } }, [s('a', { staticClass: 'header-anchor', attrs: { href: '#_1-数组迭代' } }, [t._v('#')]), t._v(' 1. 数组迭代')]),
							t._v(' '),
							s('div', { staticClass: 'language-js extra-class' }, [
								s('pre', { pre: !0, attrs: { class: 'language-js' } }, [
									s('code', [
										...
										s('span', { pre: !0, attrs: { class: 'token parameter' } }, [t._v('arr'), s('span', { pre: !0, attrs: { class: 'token punctuation' } }, [t._v(',')]), t._v(' cb')]),
										s('span', { pre: !0, attrs: { class: 'token punctuation' } }, [t._v(')')]),
										t._v(' '),
										s('span', { pre: !0, attrs: { class: 'token punctuation' } }, [t._v('{')]),
										t._v('\n\t'),
										...
										s('span', { pre: !0, attrs: { class: 'token keyword' } }, [t._v('return')]),
										t._v(' ret\n\t'),
										s('span', { pre: !0, attrs: { class: 'token comment' } }, [t._v('// 对于forEach这里为一行代码：for (let i = 0; i < arr.length; i++) cb(arr[i], i, arr)')]),
										t._v('\n'),
										s('span', { pre: !0, attrs: { class: 'token punctuation' } }, [t._v('}')]),
										t._v('\n\n'),
										s('span', { pre: !0, attrs: { class: 'token keyword' } }, [t._v('function')]),
										...
										s('span', { pre: !0, attrs: { class: 'token keyword' } }, [t._v('return')]),
										t._v(' ret\n\t'),
										s('span', { pre: !0, attrs: { class: 'token comment' } }, [t._v('// 对于find这里为一行代码：for (let i = 0; i < arr.length; i++) if(cb(arr[i], i, arr)) return arr[i]')]),
										t._v('\n'),
										s('span', { pre: !0, attrs: { class: 'token punctuation' } }, [t._v('}')]),
										t._v('\n\n'),
										s('span', { pre: !0, attrs: { class: 'token keyword' } }, [t._v('function')]),
										...
										t._v('\n\n\t'),
										s('span', { pre: !0, attrs: { class: 'token comment' } }, [t._v('//** 对于some这里为两行代码：')]),
										t._v('\n\t'),
										s('span', { pre: !0, attrs: { class: 'token keyword' } }, [t._v('for')]),
										t._v(' '),
										s('span', { pre: !0, attrs: { class: 'token punctuation' } }, [t._v('(')]),
