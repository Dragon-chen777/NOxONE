	...
	[4],
	{
			...
			var r = a(0),
				...
				o = Object(r.c)({
					...
					setup(t, e) {
						const a = Object(s.a)()
						return {
							tags: Object(r.a)(() => [{ name: a.$recoLocales.all, path: '/tag/' }, ...a.$tagesList]),
							tagClick: (t) => {
				...
				i = Object(c.a)(
					...
					function () {
						...
						return e(
							'div',
							{ staticClass: 'tags' },
							t._l(t.tags, function (a, r) {
								return e(
									'span',
									{
										directives: [{ name: 'show', rawName: 'v-show', value: !a.pages || (a.pages && a.pages.length > 0), expression: '!item.pages || (item.pages && item.pages.length > 0)' }],
										key: r,
										class: { active: a.name == t.currentTag },
		...
		440: function (t, e, a) {
			...
			var r = a(0),
				...
				i = a(344),
				u = Object(r.c)({
					components: { Common: n.a, NoteAbstract: s.a, TagList: o.a },
					setup(t, e) {
						const a = Object(i.a)()
						return {
							posts: Object(r.a)(() => {
								let t = a.$currentTags.pages
								return (t = Object(c.a)(t)), Object(c.c)(t), t
							}),
							getCurrentTag: (t) => {
								e.emit('currentTag', t)
							},
							tagClick: (t) => {
								a.$route.path !== t.path && a.$router.push({ path: t.path })
							},
							paginationChange: (t) => {
								setTimeout(() => {
									window.scrollTo(0, 0)
				...
				p = Object(g.a)(
					...
					function () {
						...
						return t(
							'Common',
							{ staticClass: 'tag-wrapper', attrs: { sidebar: !1 } },
							[
								t('TagList', { staticClass: 'tags', attrs: { currentTag: this.$currentTags.key }, on: { getCurrentTag: this.tagClick } }),
								this._v(' '),
								t('note-abstract', { staticClass: 'list', attrs: { data: this.posts, currentTag: this.$currentTags.key }, on: { paginationChange: this.paginationChange } }),
							],
							1,
						)
					},
