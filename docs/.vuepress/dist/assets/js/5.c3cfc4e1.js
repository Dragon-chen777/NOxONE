	...
	[5],
	{
		...
		441: function (t, e, a) {
			...
			var r = a(0),
				...
				c = a(344),
				i = Object(r.c)({
					components: { Common: n.a, NoteAbstract: o.a, TagList: s.a },
					setup(t, e) {
						const a = Object(c.a)()
						return {
							tagClick: (t) => {
				...
				g = Object(u.a)(
					...
					function () {
						...
						return t(
							'Common',
							{ staticClass: 'tags-wrapper', attrs: { sidebar: !1 } },
							[
								t('TagList', { attrs: { currentTag: this.$recoLocales.all }, on: { getCurrentTag: this.tagClick } }),
								this._v(' '),
								t('note-abstract', { staticClass: 'list', attrs: { data: this.$recoPosts }, on: { paginationChange: this.paginationChange } }),
							],
							1,
						)
					},
