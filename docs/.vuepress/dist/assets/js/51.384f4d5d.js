				...
				r = Object(n.a)(
					...
					function () {
						...
						return s('ContentSlotsDistributor', { attrs: { 'slot-key': t.$parent.slotKey } }, [
							s('p', [t._v('new 会执行当前的构造函数，并且加入一些语法糖操作：')]),
							t._v(' '),
							s('ol', [
								s('li', [t._v('将 this 指向新创建的 obj')]),
								t._v(' '),
								s('li', [s('code', [t._v('obj.__proto__')]), t._v('指向构造函数的 prototype')]),
								t._v(' '),
								s('li', [t._v('执行构造函数，若这个构造函数没有 return 一个对象则默认 return 这个 obj')]),
							]),
							t._v(' '),
							...
							s('div', { staticClass: 'language-js extra-class' }, [
								s('pre', { pre: !0, attrs: { class: 'language-js' } }, [
									s('code', [
										...
										s('span', { pre: !0, attrs: { class: 'token punctuation' } }, [t._v('{')]),
										t._v('\n  '),
										s('span', { pre: !0, attrs: { class: 'token comment' } }, [t._v('// let o = new Object()')]),
										t._v('\n  '),
										s('span', { pre: !0, attrs: { class: 'token comment' } }, [t._v('// o.__proto__ = constructor.prototype')]),
										t._v('\n  '),
										...
										s('span', { pre: !0, attrs: { class: 'token punctuation' } }, [t._v(')')]),
										t._v(' '),
										s('span', { pre: !0, attrs: { class: 'token comment' } }, [t._v('// 一行取代两行')]),
										t._v('\n  '),
										s('span', { pre: !0, attrs: { class: 'token keyword' } }, [t._v('let')]),
										t._v(' res '),
										s('span', { pre: !0, attrs: { class: 'token operator' } }, [t._v('=')]),
							...
							t._v(' '),
							s('p', [
								s('a', { attrs: { href: 'https://zhuanlan.zhihu.com/p/23987456', target: '_blank', rel: 'noopener noreferrer' } }, [t._v('1. JS 的 new 到底是干什么的？'), s('OutboundLink')], 1),
							]),
							t._v(' '),
							s('p', [s('a', { attrs: { href: 'https://github.com/mqyqingfeng/Blog/issues/13', target: '_blank', rel: 'noopener noreferrer' } }, [t._v('2. new 的模拟实现'), s('OutboundLink')], 1)]),
						])
					},
					[],
					!1,
