...
```
## 参考
[1. 了解JS中的类](https://www.digitalocean.com/community/tutorials/understanding-classes-in-javascript)

[2. Babel如何编译class上](https://github.com/mqyqingfeng/Blog/issues/105)

[3. Babel如何编译class下](https://github.com/mqyqingfeng/Blog/issues/106)
