...
export default defineComponent({
	...
	setup(props, ctx) {
		...
		const initialize = (userOptions, lang) => {
			Promise.all([import(/* webpackChunkName: "docsearch" */ 'docsearch.js/dist/cdn/docsearch.min.js'), import(/* webpackChunkName: "docsearch" */ 'docsearch.js/dist/cdn/docsearch.min.css')]).then(
				([docsearch]) => {
