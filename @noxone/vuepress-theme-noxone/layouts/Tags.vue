<template>
	<Common class="tags-wrapper" :sidebar="false">
		<!-- 标签集合 -->
		<TagList :currentTag="$recoLocales.all" @getCurrentTag="tagClick"></TagList>

		<!-- 博客列表 -->
		<note-abstract class="list" :data="$recoPosts" @paginationChange="paginationChange"></note-abstract>
	</Common>
</template>
